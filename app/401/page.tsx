...
export default function UnauthorizedPage() {
  return (
    <div className="min-h-screen bg-[#f3f4f6] dark:bg-[#0a0a0a] bg-grid-pattern flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-[#141414] border-4 border-black rounded-[24px] shadow-[8px_8px_0_0_#000000] p-8 text-center flex flex-col items-center">
